...
(defun create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (bg1           (if (eq variant 'dark) (if (true-color-p) "#292b2e" "#000000") (if (true-color-p) "#fbf8ef" "#ffffff")))
        ...
        (cblk-bg       (if (eq variant 'dark) (if (true-color-p) "#2f2b33" "#000000") (if (true-color-p) "#e8e3f0" "#ffffff")))
        ...
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#292e34" "#000000") (if (true-color-p) "#ecf3ec" "#ffffff")))
        ...
        (head1         (if (eq variant 'dark) (if (true-color-p) "#4f97d7" "#ff0000") (if (true-color-p) "#3a81c3" "#268bd2")))
        (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "#000000") (if (true-color-p) "#edf1ed" "#ffffff")))
        (head2         (if (eq variant 'dark) (if (true-color-p) "#2d9574" "#ffffff") (if (true-color-p) "#2d9574" "#2aa198")))
        (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#1c1c1c") (if (true-color-p) "#edf2e9" "#ffffff")))
        (head3         (if (eq variant 'dark) (if (true-color-p) "#67b11d" "#ffffff") (if (true-color-p) "#67b11d" "#5faf00")))
        (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#1c1c1c") (if (true-color-p) "#edf2e9" "#ffffff")))
        (head4         (if (eq variant 'dark) (if (true-color-p) "#b1951d" "#ffffff") (if (true-color-p) "#b1951d" "#875f00")))
        (head4-bg      (if (eq variant 'dark) (if (true-color-p) "#32322c" "#000000") (if (true-color-p) "#f6f1e1" "#ffffff")))

        (highlight     (if (eq variant 'dark) (if (true-color-p) "#444155" "#2aa198") (if (true-color-p) "#d3d3e7" "#d7d7ff")))
        (highlight-dim (if (eq variant 'dark) (if (true-color-p) "#3b314d" "#000000") (if (true-color-p) "#e7e7fc" "#d7d7ff")))
        ...
        (aqua-bg       (if (eq variant 'dark) (if (true-color-p) "#293235" "#000000") (if (true-color-p) "#edf2e9" "#ffffff")))
        (green         (if (eq variant 'dark) (if (true-color-p) "#67b11d" "#67b11d") (if (true-color-p) "#67b11d" "#5faf00")))
        (green-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#000000") (if (true-color-p) "#edf2e9" "#ffffff")))
        (green-bg-s    (if (eq variant 'dark) (if (true-color-p) "#29422d" "#000000") (if (true-color-p) "#dae6d0" "#ffffff")))
        ...
        (red-bg        (if (eq variant 'dark) (if (true-color-p) "#3c2a2c" "#000000") (if (true-color-p) "#faede4" "#ffffff")))
        (red-bg-s      (if (eq variant 'dark) (if (true-color-p) "#512e31" "#000000") (if (true-color-p) "#eed9d2" "#ffffff")))
        (blue          (if (eq variant 'dark) (if (true-color-p) "#4f97d7" "#268bd2") (if (true-color-p) "#3a81c3" "#268bd2")))
        (blue-bg       (if (eq variant 'dark) (if (true-color-p) "#293239" "#000000") (if (true-color-p) "#edf1ed" "#d7d7ff")))
        (blue-bg-s     (if (eq variant 'dark) (if (true-color-p) "#2d4252" "#000000") (if (true-color-p) "#d1dcdf" "#d7d7ff")))
        ...
        (yellow-bg     (if (eq variant 'dark) (if (true-color-p) "#32322c" "#000000") (if (true-color-p) "#f6f1e1" "#ffffff"))))
...
;;;;; ahs
     `(ahs-face ((,class (:background ,"#000000"))))
...
;;;;; helm
     ...
     `(helm-selection ((,class (:background ,"#1c1c1c"))))
...
;;;;; linum-mode
     `(linum ((,class (:foreground ,lnum :background ,"000000" :inherit default))))
